...
//   // 紫系は softInfo で統一（ui.jsxにsoftPurpleが無い想定）
...
//     const res = await fetch("http://localhost:8080/pairs/status", {
//       headers: authHeaders(),
//     });
//     const text = await res.text();
//     if (!res.ok) throw new Error(`pairs/status: ${res.status}\n${text}`);
...
//     const res = await fetch("http://localhost:8080/conditions/me/latest", {
//       headers: authHeaders(),
//     });
...
//     const text = await res.text();
//     if (!res.ok) throw new Error(`me/latest: ${res.status}\n${text}`);
...
//     const res = await fetch("http://localhost:8080/conditions/partner/latest", {
//       headers: authHeaders(),
//     });
...
//     const text = await res.text();
//     if (!res.ok) throw new Error(`partner/latest: ${res.status}\n${text}`);
...
//       return;
//     }
//     // ここに通常の初回ロード（refreshStatus/refreshAll）
...
//                 }}
//               >
//                 {myLatest ? JSON.stringify(myLatest, null, 2) : "未取得"}
//               </pre>
//             </details>
//           </Card>
...
//                   >
//                     {partnerLatest
//                       ? JSON.stringify(partnerLatest, null, 2)
//                       : "未取得"}
//                   </pre>
//                 </details>
//               </>
